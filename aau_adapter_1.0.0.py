...
class SimpleHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        print(string)
        Name_startnum = string.find('"')##从下标0开始，查找在字符串里第一个出现的子串
        Name_stopnum = string.find('"',Name_startnum+1)##从下标0开始，查找在字符串里第一个出现的子串
        Value_startnum = string.find(':',Name_stopnum)
        Value_stopnum = string.find('\n',Value_startnum)
        Name = body[Name_startnum+1:Name_stopnum];
        Value = body[Value_startnum+1:Value_stopnum];
        print(string)
